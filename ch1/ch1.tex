...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.75\textwidth]{fig_1.5}
...
each case, the conservation law on which the balance is based is specified.}}
 \begin{figure}[H]
	\centering
	\includegraphics[width=1\textwidth]{fig_1.4t}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.8\textwidth]{fig_1.6}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.80\textwidth]{fig_1.7}
...
\begin{figure}[H]
	...
	\includegraphics[width=0.45\textwidth]{fig_P1.9}
	\caption*{Figure P1.9}
   \label{fig_P1.9}
\end{figure}
...
\begin{figure}[H]
	...
	\includegraphics[width=0.45\textwidth]{fig_P1.11}
...
\begin{figure}[H]
	...
	\includegraphics[width=0.45\textwidth]{fig_P1.13}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.45\textwidth]{fig_P1.16}
